...
<head>
    <meta charset="UTF-8">
    <title>Riwayat Pulsa - PulsaKita</title>
...
<div class="sidebar">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link active" href="riwayat_user.php"><i class="bi bi-clock-history me-2"></i> Riwayat Pulsa</a>
        <hr>
        <a class="nav-link text-danger" href="logout.php"><i class="bi bi-box-arrow-left me-2"></i> Keluar</a>
    </nav>
</div>
<div class="main-content">
    <h2 class="fw-bold mb-4">Riwayat Pembelian Pulsa</h2>
    <div class="card card-custom bg-white">
        <table class="table table-hover align-middle mb-0">
            <thead class="table-light">
                <tr><th>Tanggal</th><th>Produk</th><th>Tujuan</th><th>Harga</th><th>Status</th></tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><code><?= $row['tujuan']; ?></code></td>
                    <td class="fw-bold">Rp <?= number_format($row['harga_akhir']); ?></td>
